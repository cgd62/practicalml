...
This project uses the data set of bio metrics from the paper cited below to create a prediction model that provides feedback on whether an exercise has been executed in a proper way.
